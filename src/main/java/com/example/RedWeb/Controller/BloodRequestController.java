...
public class BloodRequestController {
    ...
    public void activateEmergencyMode(@PathVariable String email) {
        // Calls the service to activate emergency mode
        bloodRequestService.activateEmergencyMode(email);
    }
}
